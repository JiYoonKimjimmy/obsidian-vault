...
```sql
--============================================================================  
-- DROP TABLES (외래 키 제약 조건 순서대로 - 자식 테이블부터 삭제)  
-- ============================================================================  
DROP TABLE IF EXISTS prepay_admin.campaign_promotion_voucher_results;  
DROP TABLE IF EXISTS prepay_admin.campaign_promotion_point_results;  
DROP TABLE IF EXISTS prepay_admin.campaign_promotion_voucher_targets;  
DROP TABLE IF EXISTS prepay_admin.campaign_promotion_point_targets;  
DROP TABLE IF EXISTS prepay_admin.campaign_promotion_summary;  
DROP TABLE IF EXISTS prepay_admin.campaign_promotions;  
-- ============================================================================
```
